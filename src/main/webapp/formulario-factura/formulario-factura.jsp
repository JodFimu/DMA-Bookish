    ...
    <body>
        <div class="container mt-5">
            ...
            <form action="${pageContext.request.contextPath}/factura-servlet" method="post">
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="totalFactura" name="totalFactura" placeholder="Total" step="0.01">
                    <label for="totalFactura">Total</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="date" class="form-control" id="fechaFactura" name="fechaFactura" placeholder="Fecha">
